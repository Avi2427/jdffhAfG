...
module.exports = {
    ...
    `)
            ...
            .addField("__**BOT BY:**__", `
    >>> <@573386403879059466>  
    `).addField("__**SUPPORT:**__", `
    >>> [\Server\](https://discord.gg/9SHFZcEmpA) |  [\Invite\](https://discord.com/api/oauth2/authorize?client_id=818042751068798986&permissions=8&scope=bot)
    `)
