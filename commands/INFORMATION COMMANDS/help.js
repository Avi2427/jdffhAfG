...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        function getAll(client, message) {
            ...
            >>> <@573386403879059466> \ [\Invite\](https://discord.com/api/oauth2/authorize?client_id=818042751068798986&permissions=8&scope=bot) | [\Support Server\](https://discord.gg/9SHFZcEmpA)
            `)
                .addField("**__Music - Supported sources__**", `
            >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`]...
            `)
                .setFooter(`By Avi | KURUVI BOT`, client.user.displayAvatarURL())
